...
const ExamPage = () => {
  ...
  const languages = [
    "C", "PHP", "Ruby", "CSharp", "Ocean", "SQL", "CPP", "Dart", "Rust",
    "VisualBasic", "Cirq", "Perl", "Python", "HTML", "Swift",
    "CoffeeScript", "Elixir", "AP", "Java", "CSS", "TypeScript",
  ...
  const handleLanguageClick = (language: string) => {
    setLoading(true);
    setTimeout(() => { 
      router.push(`/exam/${language}/level`);
    }, 500); 
  };
  ...
  return (
    <>
      <Navbar />
      <div className="flex flex-col items-center justify-start min-h-screen bg-gradient-to-rb from-[#15B392] to-white p-6">
        <h1 className="text-4xl sm:text-5xl font-bold text-center mt-10 mb-6 text-[#3C3D37]">
